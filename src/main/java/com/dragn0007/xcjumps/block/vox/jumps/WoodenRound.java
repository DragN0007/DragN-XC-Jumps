...
public class WoodenRound extends DecorRotator {
    ...
    public static final VoxelShape NORTH = Stream.of(
            ...
            Block.box(0, 2, 0, 16, 5, 2),
            Block.box(1, 2, 2, 2, 5, 16),
            Block.box(1, 7, 6, 2, 8, 16),
            Block.box(14, 8, 8, 15, 9, 14),
            Block.box(1, 8, 8, 2, 9, 14),
            Block.box(14, 5, 4, 15, 7, 16),
            Block.box(14, 2, 2, 15, 5, 16),
            Block.box(14, 7, 6, 15, 8, 16),
            Block.box(1, 5, 4, 2, 7, 16),
            Block.box(0, 5, 2, 16, 7, 4),
            Block.box(0, 7, 4, 16, 9, 6),
            Block.box(0, 8, 6, 16, 10, 8),
            Block.box(0, 9, 8, 16, 10.999999999999998, 14),
