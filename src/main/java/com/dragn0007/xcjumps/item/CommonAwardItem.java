...
public class CommonAwardItem extends Item {

    public MobEffectInstance[] effectInstances;

    public CommonAwardItem(MobEffectInstance... effectInstances) {
        super(new Properties().rarity(Rarity.COMMON).durability(10).tab(XCItemGroup.XC_GROUP));
